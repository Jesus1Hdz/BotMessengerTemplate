...
//Cambiar por un Token valido de FB
const APP_TOKEN = '';
...
app.get('/webhook', function(req, res){
	//El token de abajo puede ser el que gustes, per debes de poner el mismo en...
	//facebook->webhook
	if (req.query['hub.verify_token'] === 'token_secret_personalizado') {
...
function evaluateMessage(recipientId, message){
	...
	if(isContain(message, 'ayuda')) {
		...
		//O cambiar por un Try catch
	}else{
		finalMessage = 'HOLA, soy un un Robot automatizado para responderte y ayudate, aún estoy en desarrollo y por el momento solo repito lo que me envias : "' + message + '"';
	}
